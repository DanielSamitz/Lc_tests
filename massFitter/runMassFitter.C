...
R__ADD_INCLUDE_PATH(/home/daniel/alice/O2Physics/PWGHF/D2H/Macros/)
R__ADD_INCLUDE_PATH(/home/daniel/alice/sw/ubuntu2004_x86-64/RapidJSON/v1.1.0-alice2-10/include/)
//R__ADD_INCLUDE_PATH(/home/daniel/alice/MyStuff/Lc_tests/)
...
#include "My_HFInvMassFitter.cxx"
#include "Riostream.h"
#include "TROOT.h"
  ...
  for (unsigned int iPt = 0; iPt < nPtBins; iPt++) {
    ...
    if (isMc) {
      ...
      if (fixMean) {
        ...
        cout << "=============================== " << hMeanToFix->GetBinContent(iPt + 1) << endl;
      }
      if (fixSigma) {
        if (fixSigmaManual.empty()) {
